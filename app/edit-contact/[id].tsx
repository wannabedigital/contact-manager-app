...
export default function EditContactScreen() {
  ...
  const { contacts, updateContact, loadContacts } = useContactStore();
  ...
  useEffect(() => {
    ...
    if (contact) {
      ...
      setPhotoUri(contact.photo_uri || null);
  ...
  if (!contacts.find((c) => c.id.toString() === id)) {
    return (
      <View style={styles.container}>
        ...
        <View style={styles.loadingContainer}>
          <Text style={styles.loadingText}>Загрузка контакта...</Text>
        </View>
      </View>
    );
  }
    ...
    >
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Редактировать контакт</Text>
